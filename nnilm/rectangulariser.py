...
# This file has been copied from https://github.com/JackKelly/neuralnilm_prototype/blob/2119292e7d5c8a137797ad3c9abf9f37e7f749af/neuralnilm/rectangulariser.py
# This was necessary because it is not possible to install the project using pip


def rectangularise(data, n_segments=3, format='proportional'):
    if data.ndim == 1:
